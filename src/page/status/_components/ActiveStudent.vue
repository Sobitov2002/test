...
import { studentActive } from '../service'
...
onMounted(async () => {
    try {
        const response = await studentActive()
...
// Qidirilgan (filterlangan) o'quvchilar
...
<template>
    ...
    <div
        ...
        <div
            ...
            <div>
                <h3 class="text-2xl md:text-3xl font-bold text-white">Faol O'quvchilar</h3>
            </div>
